...
def save_comic_to_album(access_token, group_id, picture):
    ...
    album_picture_response = requests.post("https://api.vk.com/method/photos.saveWallPhoto", params=album_picture_payload)
...
def send_comic_to_wall(access_token, group_id, message, picture):
    ...
    wall_picture_response = requests.post("https://api.vk.com/method/wall.post", params=wall_picture_payload)
